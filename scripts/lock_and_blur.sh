...
if [ "$COLOR" -gt "$VALUE" ]; then #light background, use dark icon
    PARAM=(--greeter-color=00000000 --inside-color=00000000 --ring-color=0000003e \
    ...
    PARAM=(--greeter-color=ffffff00 --inside-color=ffffff00 --ring-color=ffffff3e \
...
convert "$tmpbg" -filter Gaussian -thumbnail 10% -sample 1000% -alpha off "$tmpbg"
