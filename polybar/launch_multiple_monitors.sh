...
MONITOR="DP-2-1" polybar top-main -c "$DIR"/config.ini &
MONITOR="DP-2-1" polybar bottom-main -c "$DIR"/config.ini &
MONITOR="DP-2-2" polybar top -c "$DIR"/config.ini &
MONITOR="DP-2-2" polybar bottom -c "$DIR"/config.ini &
